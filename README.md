...
| --- | --- | --- | --- | --- |
| [OPT-PY-001](optimizations/OPT-PY-001-deterministic-test-execution.md) | Deterministic test execution | **Verified mechanism; benchmark context incomplete** | QEC v68.2.0–v68.4.1 | ~126 s → ~46 s in v68.4.0 release; ~40 s after v68.4.1; original runner/toolchain/repetition context not preserved, so re-benchmark before transfer |
...
| [OPT-LEAN-001](optimizations/OPT-LEAN-001-trust-preserving-lean-ci.md) | Trust-preserving Lean dependency reuse | **Verified on source PR; timings environment-scoped** | QSOL-GEO-REASON PR #3 | 2501.52 s cold dependency reconstruction and 8.47 s verified-cache project rebuild are different-scope single observations on four-CPU Ubuntu lanes; see record |
