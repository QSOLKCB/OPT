...
- X: target-supported shard/domain counts, namespace splits, worker-to-domain mappings, merge/aggregation policies, ownership-lease policies, fencing-epoch schemes, and restart-safe allocator-state policies
- F: configurations that preserve the target's required uniqueness, exclusive ownership, visibility, failure-domain, and ordering guarantees through assignment, rebalance, same-owner restart, crash recovery, and split-brain recovery
...
- Constraints: uniqueness, ownership, ordering, visibility, failure-domain, lease/fencing, durable allocator-state, and resource constraints
